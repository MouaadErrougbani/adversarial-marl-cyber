...
if __name__ == '__main__':
    ...
    print("Seed:", SEED)
    print("Episode length:", HYPER_PARAMS.episode_len)
    print("Episodes per update:", HYPER_PARAMS.N)
    print("Training episodes:", HYPER_PARAMS.training_episodes)
    print("Workers:", HYPER_PARAMS.workers)
    print("Batch size:", HYPER_PARAMS.bs)
    print("Hidden layer dimension:", args.hidden)
    print("Embedding dimension:", args.embedding)
    print("=="*40)
    # print(args)
